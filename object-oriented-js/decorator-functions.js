...
var changeTruck = function(obj, loc) {
  obj.loc = loc;
  obj.move = move;
  //adding a move function this way allows the changeTruck decorator to add methods that can be called on inherited objects.
  return obj;
}
...
//In this case, a new function is created every time changeBike is called.
